...
typedef NotificationDashboardChanged(String? value, int? privilegeLevel,);
...
class NotificationDashboardDropdownButtonWidget extends StatefulWidget {
  ...
  NotificationDashboardDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
return widgets;
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: DropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a notificationDashboard'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'notificationDashboards', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<NotificationDashboardListBloc>(context).add(NotificationDashboardChangeQuery(
