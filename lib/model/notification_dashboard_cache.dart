...
class NotificationDashboardCache implements NotificationDashboardRepository {
  ...
  final Map<String?, NotificationDashboardModel?> fullCache = {};
  ...
  @override
  StreamSubscription<List<NotificationDashboardModel?>> listen(trigger,
      {String? orderBy,
      bool? descending,
      Object? startAfter,
      int? limit,
  ...
  static Future<NotificationDashboardModel> refreshRelations(
      NotificationDashboardModel model) async {
