    ...
    return BlocBuilder<NotificationFormBloc, NotificationFormState>(builder: (context, state) {
      ...
      if (state is NotificationFormInitialized) {
        ...
        children.add(
                  ...
                  StyleRegistry.registry().styleWithContext(context).adminFormStyle().checkboxListTile(context, 'Has this been read?', _readSelection, _readOnly(accessState, state) ? null : (dynamic val) => setSelectionRead(val))
          );
