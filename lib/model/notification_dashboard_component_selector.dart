...
import 'notification_dashboard_list_bloc.dart';
import 'notification_dashboard_list_event.dart';
...
class NotificationDashboardComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<NotificationDashboardListBloc>(
      ...
      child: SelectNotificationDashboardWidget(app: app,
          height: height,
...
class SelectNotificationDashboardWidget extends StatefulWidget {
  ...
  @override
  _SelectNotificationDashboardWidgetState createState() {
    return _SelectNotificationDashboardWidgetState();
  }
}

class _SelectNotificationDashboardWidgetState extends State<SelectNotificationDashboardWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<NotificationDashboardListBloc>(context).add(
            NotificationDashboardChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }

  Widget theList(BuildContext context, List<NotificationDashboardModel?> values) {
    var app = widget.app; 
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<NotificationDashboardListBloc, NotificationDashboardListState>(
      ...
      if ((state is NotificationDashboardListLoaded) && (state.values != null)) {
